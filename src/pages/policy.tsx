...
const LAST_UPDATED = new Date(2023, 12 - 1, 18);
  ...
  return (
    <>
      ...
      <article className="prose mx-auto px-4 py-10 dark:prose-invert">
        ...
        <ul>
          <li>
            <strong>Authentication</strong>: To sign you into Videoduel and
        ...
        <ul>
          <li>
            ...
            from our platform, please navigate to your user profile and click
            the &quot;Delete account&quot; button or contact the site owner, and
            we will assist you in deleting your information from our systems.
          </li>
          <li>
        ...
        <p>
          ...
          policy. If there are significant changes in the way we handle personal
          information, we will notify you by prominently posting a notice of
          such changes before they take effect or directly send you a
          notification.
        </p>
        <h3>9. Contact Us</h3>
        <p>
          If you have any questions about our practices or this policy, please
          contact us <a href="mailto:brandon@carlisle.dev">here</a>.
        </p>
      </article>
    </>
  );
